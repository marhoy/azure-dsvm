...
#c.JupyterHub.data_files_path = '/data/miniconda/envs/jupyterhub/share/jupyterhub'
...
c.Spawner.cmd = ['/data/miniconda/envs/jupyterhub/bin/jupyterhub-singleuser']

# Extra arguments to be passed to the single-user server
c.Spawner.args = ['--config=/etc/jupyterhub/jupyter_notebook_config.py']
